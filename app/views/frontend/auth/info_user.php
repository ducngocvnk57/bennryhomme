		...
		<div class="form form-account cust-sel clearfix">
			<div class="col">
				...
				<div class="f-row">
					...
					<div class="f-input">
						<input name="data[email]" type="text" id="tb_Nemail"  value="<?php echo (isset($post_data['email'])?$post_data['email']:'');?>" placeholder="Email"/>
					</div>
				</div>
				<div class="f-row">
				...
				<div class="f-row">
					...
					<div class="f-input">
					<input name="data[fullname]" type="text" id="tb_fullName"  value="<?php echo (isset($post_data['fullname'])?$post_data['fullname']:'');?>" placeholder="Full Name"/></div>
				</div>
				<div class="f-row">
					<label for="f3">Address</label>
					<div class="f-input">
					<input name="data[address]" type="text" id="tb_address"  value="<?php echo (isset($post_data['address'])?$post_data['address']:'');?>" placeholder="Address" /></div>
				</div>
				<div class="f-row">
					<label for="f3">Phone</label>
					<div class="f-input">
					<input name="data[phone]" type="text" id="tb_phone"  value="<?php echo (isset($post_data['phone'])?$post_data['phone']:'');?>" placeholder="Phone" /></div>
				</div>
				<div class="f-buttons">
					<input type="submit" name="chang_info" class="submit" value="Cập nhật thông tin">
				</div>
				</form>
			</div>
		</div>
