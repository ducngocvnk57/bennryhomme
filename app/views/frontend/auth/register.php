	...
	<div class="login-register clearfix">
		...
		<div class="form form-account cust-sel clearfix">
			...
			<form action="" method="post">
				...
				?>
				<div class="f-row">
					<label for="f5">User</label>
					<div class="f-input">
						<input name="data[user]" type="text" id="tb_rtusername"  value="<?php echo (isset($post_data['user'])?$post_data['user']:'');?>" placeholder="User Name" />
					</div>
				</div>
				<div class="f-row">
					<label for="f6">Password</label>
					<div class="f-input">
						<input name="data[password]" type="password" id="tb_password" placeholder="Password"/>
					</div>
				</div>
				<div class="f-row">
					<a href="quen-mat-khau.html">Forgot Your Password?</a>
				</div>
