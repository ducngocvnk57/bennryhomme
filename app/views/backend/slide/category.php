<div id="cms-tab">
	...
	<ul class="main">
		<li class="main"><a href="<?php echo CMS_BACKEND.'/slide/category'.CMS_SUFFIX;?>" class="main main-select">Quản lý danh mục slide</a></li>
		<li class="main"><a href="<?php echo CMS_BACKEND.'/slide/addcategory'.CMS_SUFFIX;?>" class="main">Thêm danh mục slide mới</a></li>
	</ul>
...
<div id="cms-container">
	<div id="cms-filter">
		<div class="right">
			<input type="submit" class="button cms-publish-ajax" value="Xuất bản" name="slide_category" />
			<input type="submit" class="button cms-unpublish-ajax" value="Dừng xuất bản" name="slide_category" />
			<input type="submit" class="button cms-order-ajax" value="Sắp xếp" name="slide_category" />
			<input type="submit" class="button cms-delete-category-ajax" value="Xóa nhiều" name="slide_category" />
		</div><!-- .right -->
		<div class="cms-clear"></div>
	</div><!-- #cms-filter -->
	<div id="cms-table">
		...
		<table cellspacing="0" cellpadding="0" class="data">
			...
			<tr <?php echo (($key + 1) == count($full_data))?'class="last"':'';?>>
				...
				<td class="left title"><a href="<?php echo CMS_URL.CMS_BACKEND.'/slide/editcategory/'.$val['id'].CMS_SUFFIX;?>"><?php echo str_repeat('|----- ', $val['level']).htmlspecialchars($val['title']);?></a></td>
				<td class="center"><?php echo helper_module_count_item('slide_item', $val['id']);?></td>
				...
				<td class="center">
					<a class="cms-set-ajax" href="<?php echo CMS_URL.CMS_BACKEND.'/common/set/slide_category/publish/'.$val['id'].CMS_SUFFIX;?>">
				...
				<td class="center">
					<a href="<?php echo CMS_URL.CMS_BACKEND.'/slide/editcategory/'.$val['id'].CMS_SUFFIX;?>"><img src="template/backend/images/edit.png" /></a>
				</td>
				<td class="center last"><?php echo $val['id'];?></td>
			</tr>
			<?php } } else{ ?>
			<tr class="last"><td class="center first" colspan="14">Không có dữ liệu danh mục slide.</td></tr>
			<?php } ?>
		</table>
		</form>
	</div><!-- #cms-table -->
